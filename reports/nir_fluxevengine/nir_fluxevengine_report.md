...
![Рисунок 1. Оборот по регионам](figure1_region_turnover.png)
...
![Рисунок 2. Топ-10 товаров Jita по обороту](figure2_jita_top10_turnover.png)
...
![Рисунок 3. Сравнение прогнозных траекторий](figure3_forecast_comparison.png)
...
![Рисунок 5. Победы методов по критерию validation MAE](figure5_method_wins.png)
...
![Рисунок 4. Верификация на отложенном окне](figure4_validation_holdout.png)
...
![Рисунок 6. Доходность агентных стратегий](figure6_agent_returns.png)
...
![Рисунок 7. Динамика капитала агентов в сценарии Pump and Dump](figure7_agent_equity_curves.png)
